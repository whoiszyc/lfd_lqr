...
# NOC control
U_noc = dyn_noc(A, Bu, Bd, x0, xf, [0.1], T_series)  # solve NOC problem
Xt_noc = dyn_sim_discrete_time(A, Bu, Bd, x0, U_noc, np.array([[0.1]]), T_series)  # simulate NOC
...
plt.savefig("fig_case_comp_small_r_t20.pdf")